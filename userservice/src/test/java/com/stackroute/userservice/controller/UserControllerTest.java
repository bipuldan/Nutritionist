...
import com.stackroute.userservice.services.JwtSecurityTokenGenerator;
...
public class UserControllerTest {
	...
	public void setUp() {
		...
		user = new User("Bipul", "Dan", "Bipuldan", "bipuldan", new Date());
	}
	...
	public void testLoginUser() throws Exception {
		when(service.saveUser(user)).thenReturn(true);
		when(service.findByUserIdAndPassword("Bipuldan", "bipuldan")).thenReturn(user);
